...
#' @param cache logical. Whether or not to cache the data so that it is not downloaded every time the function is called.
#' @param clearCache logical. Whether or not to clear the downloaded data from the cache.
...
#' Data from: Gandrud, Christopher. 2013. "The Diffusion of Financial Supervisory Governance Ideas." Review of International Political Economy. 20(4):881-916
...
source_DropboxData <-function(file, key, sha1 = NULL, cache = FALSE, clearCache = FALSE, sep = ",", header = TRUE, ...)
{
