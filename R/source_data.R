...
#' @param quote  the set of quoting characters. To disable quoting altogether, use \codequote = ""}. See \code{\link{scan}} for the behaviour on quotes embedded in quotes. 
